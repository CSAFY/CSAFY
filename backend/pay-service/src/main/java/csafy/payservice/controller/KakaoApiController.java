package csafy.payservice.controller;

import csafy.payservice.client.UserServiceClient;
import csafy.payservice.dto.payments.KakaoPayApprovalVO;
import csafy.payservice.dto.response.ErrorResponse;
import csafy.payservice.service.KakaoPayService;
...
public class KakaoApiController {
    ...
    public ResponseEntity kakaoPaySuccess(@RequestParam("pgToken") String pg_token,
        ...
        if (token == null || !resultCode.equals("OK")) {
